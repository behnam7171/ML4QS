...
DATASET_FNAME = 'mnb_chapter3_result_outliers_final.csv'
RESULT_FNAME = 'mnb_chapter3_imputation_result_final.csv'
...
def main():
    ...
    if FLAGS.mode == 'imputation':
        ...
        imputed_model_based_dataset = MisVal.impute_knn(copy.deepcopy(dataset), 'acc_phone_x')

        DataViz.plot_imputed_values(dataset, ['original','interpolation', 'KNN'], 'acc_phone_x',
                                    imputed_interpolation_dataset['acc_phone_x'],
                                    imputed_model_based_dataset['acc_phone_x'])
