...
EXPORT_TREE_PATH = Path('mnb_figures/example_graphs/Chapter7/')
...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'acc_phone_y', '2022-06-08 16:20:45',
                                                                                   '2022-06-08 16:40:16', '2022-06-08 16:47:05')
...
basic_features = ['acc_phone_x','acc_phone_z','gyr_phone_x','gyr_phone_y','gyr_phone_z',
                  'labelWalking', 'labelSitting','labelRunning','labelOnthetable','labelCycling',
...
selected_features = ['acc_phone_y_freq_0.0_Hz_ws_40', 'gyr_phone_y_freq_2.0_Hz_ws_40', 'gyr_phone_y_freq_1.9_Hz_ws_40',
                     'gyr_phone_y_freq_1.8_Hz_ws_40', 'gyr_phone_y_freq_1.7_Hz_ws_40', 'gyr_phone_y_freq_1.6_Hz_ws_40',
                     'gyr_phone_z', 'gyr_phone_y_freq_1.4_Hz_ws_40', 'gyr_phone_y_freq_1.5_Hz_ws_40', 'gyr_phone_y_freq_0.3_Hz_ws_40']
...
DataViz.plot_numerical_prediction_versus_real(train_X.index, train_y, regr_train_y, test_X.index, test_y, regr_test_y, 'acc_phone_y')
