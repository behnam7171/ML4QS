...
RESULT_FNAME = 'mnb_chapter7_classification_result.csv'
EXPORT_TREE_PATH = Path('./figures/mnb_ch7_classification/')
...
selected_features = ['acc_phone_y_freq_0.0_Hz_ws_40', 'gyr_phone_x_temp_std_ws_120',
                     'light_phone_lux_temp_std_ws_120', 'mag_phone_z_max_freq', 'gyr_phone_y_freq_1.0_Hz_ws_40',
...
DataViz.plot_xy(x=[reg_parameters, reg_parameters], y=[performance_training, performance_test], method='semilogx',
                xlabel='regularization parameter value', ylabel='accuracy', ylim=[0.7, 1.01],
